package com.easv.rtl.myfriends.GUI
...
import com.easv.rtl.myfriends.Model.BEFriend
import com.easv.rtl.myfriends.Model.Friends
import com.easv.rtl.myfriends.R
...
class MainActivity : ListActivity() {
    ...
    override fun onListItemClick(parent: ListView?, v: View?, position: Int, id: Long) {
        ...
        // and a greeting
        Toast.makeText(this, "Hi $name! Have you done your homework?", Toast.LENGTH_LONG).show()
    }
    ...
    internal class FriendAdapter(context: Context, private val friends: Array<BEFriend>) : ArrayAdapter<BEFriend>(context, 0, friends)
    {
        ...
        override fun getView(position: Int, v: View?, parent: ViewGroup): View {
            ...
            val nameView = resView.findViewById<TextView>(R.id.tv_name)
            val phoneView = resView.findViewById<TextView>(R.id.tv_phone)
            val favoriteView = resView.findViewById<ImageView>(R.id.img_favorite)
